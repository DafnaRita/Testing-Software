...
public class BinomialHeap {
    ...
    public static BinomialHeap merge(BinomialHeap heap1, BinomialHeap heap2) {
        System.out.println("Вошли в merge функцию");
        System.out.println("1 биномиальный хип:" + heap1.toString());
        System.out.println("2 биномиальный хип:" + heap2.toString());
        BinomialHeap h = new BinomialHeap();
        System.out.println("Результирующий биномиальный хип:" + h.toString() + '\n');

        HeapNode p1 = heap1.getFirst();
        System.out.println("Указатель на первое дерево в 1 хипе(p1) :" +p1 + '\n');
        HeapNode p2 = heap2.getFirst();
        System.out.println("Указатель на первое дерево в 2 хипе(p2) :" +p2 + '\n');

        // merge-sort two linked lists of binomial trees
        System.out.println("Старт merge цикла:");
        while (p1 != null && p2 != null) {
            if (p1.getRank() <= p2.getRank()) {
                System.out.println("Ранг дерева в 2 хипе меньше или равен дереву в 1 хипе, добавляем 1 дерево");
                h.addTree(p1);
                System.out.println("Добавить дерево 1 хипа в результирующий");
                System.out.println("Результирующий хип:" + h.toString());
                p1 = p1.getNext();
                System.out.println("Следующее дерево 1 хипа: " + p1);
            } else {
                System.out.println("Ранг дерева в 2 хипе меньше чем дерева в 1 хипе");
                h.addTree(p2);
                System.out.println("Результирующий хип:" + h.toString());
                p2 = p2.getNext();
                System.out.println("Следующее дерево 2 хипа: " + p2);
            }
        }

        System.out.println("Остались деревья только в одном из хипов");
        ...
        System.out.println("Come out merge function");
        System.out.println("Final mergered BinomialHeap:" + h.toString());
        return h;
    }
