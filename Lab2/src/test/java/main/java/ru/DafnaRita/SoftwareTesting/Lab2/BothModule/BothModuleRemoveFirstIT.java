...
import main.java.ru.DafnaRita.SoftwareTesting.Lab2.Logarithm.SecondStatement;
...
public class BothModuleRemoveFirstIT {
    //trigonometry
    ...
    public BothModuleRemoveFirstIT(double inputX, double expectedX){
        this.inputX = inputX;
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                ...
                {0.,Double.NaN},
                {0.+ delta, 1.234969*Math.pow(10, 12)},
                {0.6,-0.32833997},
                {1. + delta,-0.34869274},
                {1.,Double.NaN},
                {1. - delta, -0.34869274},
    ...
    public void pointTest(){
        ...
        System.out.println("real :" + firstStatement.execute(inputX));
        if(inputX <= 0) {
